...
const auditData: AuditCategory[] = [
  ...
  {
    id: 'mobile',
    label: 'Adaptação Mobile (App do Paciente)',
    icon: Smartphone,
    iconColor: 'var(--scolio-success-green)',
    items: [
      {
        id: 'm1',
        title: 'Formulários de feedback de saúde (Wellness Log)',
        description: 'WellnessLogScreen.tsx implementado com escala de dor, nível de conforto, campo de notas livres e histórico de registos anteriores.',
        status: 'pass',
      },
      {
        id: 'm2',
        title: 'Centro de notificações para novos relatórios',
        description: 'NotificationsScreen.tsx implementado com grupos por data, ícones por tipo, estados lido/não lido e navegação para o conteúdo relevante.',
        status: 'pass',
      },
      {
        id: 'm3',
        title: 'Configuração completa de 2FA',
        description: "ProfileScreen.tsx tem apenas um toggle on/off sem fluxo de configuração. Falta: QR code para autenticador, verificação do código OTP, códigos de recuperação e instruções de instalação.",
        status: 'partial',
        severity: 'high',
        recommendation: "Criar TwoFactorSetupScreen.tsx com fluxo de 3 passos: (1) Instalar app autenticador, (2) Digitalizar QR code, (3) Confirmar código OTP. Gerar e apresentar 8 códigos de recuperação.",
        route: '/mobile/2fa-setup',
        routeLabel: 'Ver ecrã implementado →',
      },
      {
        id: 'm4',
        title: 'Tradução completa para Português de Portugal',
        description: "ProfileScreen.tsx contém texto em inglês: 'My data', 'Full name', 'Security', 'Change password', 'Preferences'. Inconsistência linguística numa app clínica.",
        status: 'fail',
        severity: 'medium',
        recommendation: "Traduzir todos os textos do ProfileScreen.tsx para Português de Portugal. Verificar também NotificationsScreen.tsx ('New exam report available', etc.).",
        route: '/mobile/profile',
        routeLabel: 'Ver perfil corrigido →',
      },
    ],
  },
  {
